...
public class CheckPassFragment extends Fragment implements View.OnClickListener {
    ...
    public CheckPassFragment(Activity activity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_check_pass, container, false);
        init(rootView);
